...
export const insertRep01TagSchema = z.object({
...
export const updateRep01TagSchema = z.object({
...
export type CreateRep01TagDto = z.infer<typeof insertRep01TagSchema>;
export type UpdateRep01TagDto = z.infer<typeof updateRep01TagSchema>;
