  ...
  const reportSections = [
    ...
    },
    {
      ...
      links: [
        ...
        {
          href: '/monthly-report-status-registry',
          title: 'Monthly Report Status Registry',
        ...
        {
          href: '/corrective-status-registry',
          title: 'Corrective Status Registry',
          description: 'Manage status mappings for weekly corrective data',
          icon: '🔧',
          color: 'cyan',
        },
      ],
