...
test.describe('Smoke Tests', () => {
  ...
  test('error-categorization page loads', async ({ page }) => {
    await page.goto('/error-categorization');
    await expect(page.getByRole('heading', { name: 'Error Categorization', exact: true })).toBeVisible();
  });
});
