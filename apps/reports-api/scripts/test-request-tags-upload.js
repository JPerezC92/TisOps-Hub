// ============================================
// Test Script: Request Tags Upload Test
// ============================================
// Purpose: Test the Request Tags upload endpoint with actual Excel file
// Usage: node scripts/test-request-tags-upload.js
// ============================================
...
// Configuration
// ============================================
const API_URL = 'http://localhost:3000/request-tags/upload';
const FILE_PATH = path.join(__dirname, '../files/REP01 XD TAG 2025.xlsx');

console.log('🚀 Request Tags Upload Test Script');
console.log('================================\n');
      ...
      res.on('end', () => {
        ...
        try {
          ...
          if (res.statusCode >= 200 && res.statusCode < 300) {
            ...
            if (jsonData.imported !== undefined) {
              console.log(`   • Records imported: ${jsonData.imported}`);
            }
            if (jsonData.skipped !== undefined) {
              console.log(`   • Records skipped: ${jsonData.skipped}`);
            }
